    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background: #2980b9;">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.jsp">
                ...
                <img src="images\Logo\ApniDukan.png" alt="logo" width="45" height="35" class="d-inline-block align-text-top navbar-logo">
            </a>
            ...
            <div class="item">
                <div class="homeimg1" >
                    <div class="content">
                        ...
                        <p>Get upto 30% OFF on CLOTHING, SHOES, ACCESSORIES</p>
                        <a href="login.jsp"><button class="LandingPageButton">Get Started</button></a>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class = "homeimg2" >
                    <div class="content">
                        ...
                        <p>Get the features of the latest gadgets online at low prices.</p>
                        <a href="login.jsp"><button class="LandingPageButton">Get Started</button></a>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class = "homeimg3">
                    <div class="content">
                        ...
                        <p>A sneaker that demands attention by defying convention. </p>
                        <a href="login.jsp"><button class="LandingPageButton">Get Started</button></a>
                    </div>
                </div>
            </div>
