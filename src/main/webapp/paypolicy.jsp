...
<title>Apni Dukaan</title>
  ...
  <body>
    ...
    <section style="padding:20px 70px" id="content">
        ...
        <p>Yes. Easy  Buy offers you the convenience of using your bank's Internet Banking service to make a payment towards your order. With this you can directly transfer funds from your bank account, while conducting a highly secure transaction.</p>
        <p>We accept payment through Internet Banking for the following banks:</p>
        <table class="table">
          <tbody>
            <tr>
              <td>State Bank of Sri Lanka</th>
              <td>ICICI Bank</td>
              <td>HDFC Bank</td>
              <td> National Bank</td>
            </tr>
            ...
            <tr>
              <td>Standard Chartered Sri Lanka</th>
              <td>Union Bank of Sri Lanka/td>
        ...
        <p>Yes, you can make credit card payments through the Easy Buy mobile site and application. Apni Dukaan uses 256-bit encryption technology to protect your card information while securely transmitting it to the secure and trusted payment gateways managed by leading banks.</p>
        ...
        <p>With Easy Buy credit card EMI option, you can choose to pay in easy installments of 3, 6, 9, 12, 18*, or 24 months* with credit cards from the following banks:</p>
        <ul>
            <li>HDFC</li>
            <li>Citi</li>
            <li>ICICI</li>
        ...
        <p>Once you've added the desired items to your  Easy Pay shopping cart, proceed with your order as usual by entering your address. When you're prompted to choose a payment mode for your order, select 'EMI' & follow these simple steps:</p>
        <ul>
