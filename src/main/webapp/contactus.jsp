              ...
              <div class="contact-table">
                <form action="https://formspree.io/f/mgerlvrl" method="POST" id="my-form">
                  <div class="input-container">
                    ...
                    <p class="invalid-feedback">Invalid name entered. Digits and symbols are not allowed.</p>
                  </div>
                  <div class="input-container">
                    ...
                    <p class="invalid-feedback">Invalid email entered.</p>
                  </div>
                  <div class="input-container">
          ...
          <div style="width: 33%!important;" id="social-section" class="col-md-4">
            <div class="box-sz" style="padding:0px 20px;padding-bottom: 15px;border-bottom:3.5px solid grey">
              <div style="display: flex;justify-content: center;margin-bottom: 10px;">
                ...
                <span class="footer-details"><span>Main Road, Dickwella , Matara</span></span>
              </div>
              <a href="mailto:info@apnidukaan.com" style="text-decoration: none;">
                <p class="footer-details"><i class="fa fa-envelope mr-5" aria-hidden="true"></i><span>sandumidilthara729@.com</span></p>
              </a>
              <p class="footer-details"><i class="fa fa-phone mr-5" aria-hidden="true"></i><span>041-2367890</span></p>
              <p class="footer-details"><i class="fa fa-fax mr-5" aria-hidden="true"></i><span>011-278904321</span></p>
            </div>
            <div id="social-media-icons">
              <a href="https://www.facebook.com"><i class="fa fa-facebook-square social-media" aria-hidden="true"></i></a>
              <a href="https://www.linkedin.com"><i class="fa fa-linkedin-square social-media" aria-hidden="true"></i></a>
              <a href="https://www.twitter.com"><i class="fa fa-twitter social-media" aria-hidden="true"></i></a>
              <a href="https://github.com/QAZIMAAZARSHAD/Apni-Dukaan"><i class="fa fa-github social-media" aria-hidden="true"></i></a>
              <a href="https://www.instagram.com"><i class="fa fa-instagram social-media" aria-hidden="true"></i></a>
            </div>
