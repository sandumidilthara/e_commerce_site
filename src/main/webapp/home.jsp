    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/pexels-tima-miroshnichenko-5662862.jpg" class="d-block w-100" alt="...">
            ...
            <div class="carousel-item">
                <img src="images/pexels-karolina-grabowska-5625008.jpg" class="d-block w-100" alt="..." style="width: 80px;">
                <div class="carousel-caption d-md-block">
    ...
    <div class="container">
        <div class="row">
            <div style="width:50%!important" class="col-lg-6 col-md-6 col-12  col-xxl-6 grow">
                <figure>
                    <img src="images/New Arrival Sale Instagram Video Post.png" alt="offer 1" class="img-fluid content rounded ">
                </figure>
            </div>
            <div style="width:50%!important" class="col-lg-6 col-md-6 col-12  col-xxl-6 grow">
                <figure>
                    <img src="images/Flash Sale Facebook Instagram Post.png" alt="offer 1" class="img-fluid content rounded">
                </figure>
            </div>
            <div style="width:50%!important" class="col-lg-6 col-md-6 col-12  col-xxl-6 grow">
                <figure>
                    <img src="images/Today Only Big Sale Instagram Video Post.png" alt="offer 1" class="img-fluid content rounded">
                </figure>
            </div>
            <div style="width:50%!important" class="col-lg-6 col-md-6 col-12  col-xxl-6 grow">
                <figure>
                    <img src="images/Back to School Sale Instagram Video Post.png" alt="offer 1" class="img-fluid content rounded">
                </figure>
            </div>
        </div>
    </div>
    ...
    <div class="row py-3">
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/VIVO.jpg" class="card-img" alt="mobile">
                <div class="card-body">
                    <h5 class="card-title">Mobile Phones</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="mobile.jsp" class="btn btn-primary">Check out</a>
                </div>
            </div>
        </div>
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/201124-tvs-commerce-2x1-mn-0925.jpg" class="card-img" alt="mobile">
                <div class="card-body">
        ...
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/download.jpg" class="card-img" alt="mobile">
                <div class="card-body">
                    <h5 class="card-title">Applianaces</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="#" class="btn btn-primary">Check out</a>
                </div>
            </div>
        ...
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images//1592920567-mid-century-double-pop-up-coffee-table-walnut-white-marble-2-c.jpg" class="card-img" alt="mobile">
                <div class="card-body">
        ...
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/istockphoto-864501328-612x612.jpg" class="card-img" alt="mobile">
                <div class="card-body">
        ...
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/100-years-of-fashion-cover-lapolo.jpg" class="card-img" alt="mobile">
                <div class="card-body">
        ...
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/grocery.png" class="card-img" alt="mobile">
                <div class="card-body">
        ...
        <div class="col md-3">
            <div class="card mx-auto" style="width:18rem; margin-bottom: 5%;">
                <img src="images/deals.png" class="card-img" alt="mobile">
                <div class="card-body">
                    <h5 class="card-title">Top Deals</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <a href="./offers.jsp" class="btn btn-primary">Check out</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container text-md-left">
        <div class="row text-md-left">
            <div class="col mt-3" style="color:#808080;">
                ...
                <p>
                    <a href="Partner Stores.jsp" class="text-white" style="text-decoration: none;">Our Partners</a>
                </p>
            </div>
            <div class="col mt-3"  style="color:#808080;">
            ...
            <div class="col mt-3" style="color:#808080;">
                ...
                <p>
                    <a href="Partner Stores.jsp" class="text-white" style="text-decoration: none;">Become our partner</a>
                </p>
                <p>
