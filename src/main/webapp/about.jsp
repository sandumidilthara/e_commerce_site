...
<div class ="aboutUsContentContainer aboutUsContent" >
    ...
    <div class="aboutDesc fadeIn mid1-sz">EasyPay.com is an E-commerce company that started in 2020. Ecommerce is guided by four principles: customer obsession rather than competitor focus, passion for invention, commitment to operational excellence, and long-term thinking. We strive to have a positive impact on customers, employees, small businesses, the economy, and the communities where we’re located.
    </div>
    <div class="w3-container w3-center DescContainerLeft" id="slideLeft" style="margin-right: auto; margin-left: auto;width: fit-content;">
        <div class="DescBoxLeft mid2-sz">Easy Pay Cares</div>
        <p class="mid3-sz" style="text-align: center; margin-top:50px;color: rgb(128, 128, 128);">EasyBuy is a smart, passionate builder with different backgrounds and goals, who share a common desire to always be learning and inventing on behalf of our customers. We believe that if you’re not left with an amazing experience, we haven’t done our job. We don’t measure success through achievements or awards, but through the satisfaction of our customers.</p>
    </div>
