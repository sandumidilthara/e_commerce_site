...
<title>Apni Dukaan</title>
  ...
  <body>
    ...
    <section style="padding:20px 70px" id="content">
        <h1 class="mid1-sz" style="font-weight: 450!important;padding: 0px!important;text-align: center;border-bottom: 2px solid #000;padding-bottom: 5px!important;margin-bottom: 15px">Shipping Policy</h1>
        <p style="color:#2980b9;font-weight: 500;margin-top: 10px"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> What are the delivery charges?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> Why does the delivery date not correspond to the delivery timeline of X-Y business days?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> What is the estimated delivery time?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> Are there any hidden costs (sales tax, octroi etc) on items sold by Sellers on Apni Dukaan?</p>
        <p>There are NO hidden charges when you make a purchase on Apni Dukaan. List prices are final and all-inclusive. The price you see on the product page is exactly what you would pay.</p>
        <p>Delivery charges are not hidden charges and are charged (if at all) extra depending on the Seller's shipping policy.</p>
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> Why does the estimated delivery time vary for each seller?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> Seller does not/cannot ship to my area. Why?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> Why is the CoD option not offered in my location?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> I need to return an item, how do I arrange for a pick-up?</p>
        ...
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i>  What do the different tags like "In Stock", "Available" mean?</p>
        <p style="font-weight: 500">'In Stock'</p>
        ...
        <p style="font-weight: 500">'Available'</p>
        ...
        <p style="font-weight: 500">'Preorder' or 'Forthcoming'</p>
        ...
        <p style="font-weight: 500">'Out of Stock'</p>
        <p>Currently, the item is not available for sale. Use the 'Notify Me' feature to know once it is available for purchase.</p>
        <p style="color:#2980b9;margin-top: 15px;font-weight: 500"><i style="margin-right: 8px" class="fa fa-question-circle" aria-hidden="true"></i> Does Apni Dukaan deliver internationally?</p>
        <p>As of now, Apni Dukaan doesn't deliver items internationally.</p>
