...
@WebServlet(name = "OrdersAll" , value = "/order-list")
public class OrdersAll extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<OrderDetailDTO> allCustomer=new ArrayList<>();
        try {

        Connection connection =    dataSource.getConnection();
            ResultSet resultSet=connection.prepareStatement("SELECT * FROM order_detail").executeQuery();
            while (resultSet.next()){
                OrderDetailDTO customerDTO=new OrderDetailDTO(
            ...
            resp.sendRedirect("?orders.jsp=Failed to retrieve customer");
